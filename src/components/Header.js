function Header() {
    return (
      ...
      <div className=" z-10 flex flex-col items-center justify-between py-8 text-white md:px-32 md:py-8 md:flex-row sticky top-0 bg-[#131321]  bg-opacity-60 backdrop-blur-sm rounded-b-3xl">
